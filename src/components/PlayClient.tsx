    ...
    >
        ...
        <header className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-md shadow-sm flex justify-between items-center px-6 py-4">
          ...
          <nav className="hidden md:flex items-center gap-8 font-headline text-sm font-bold tracking-tight">
            <Link href="/" className="text-primary font-bold" onClick={(e) => e.stopPropagation()}>Chronicle</Link>
            <Link href="/archive" className="text-on-surface/50 hover:bg-surface-container-high/50 transition-all px-3 py-1 rounded-full" onClick={(e) => e.stopPropagation()}>Archive</Link>
            <Link href={`/story/${storyId}/role`} className="text-on-surface/50 hover:bg-surface-container-high/50 transition-all px-3 py-1 rounded-full" onClick={(e) => e.stopPropagation()}>Roles</Link>
            <Link href="/profile" className="text-on-surface/50 hover:bg-surface-container-high/50 transition-all px-3 py-1 rounded-full" onClick={(e) => e.stopPropagation()}>Profile</Link>
          </nav>
